...
import 'package:transaction_mobile_app/presentation/screens/transfer/widgets/wallet_card.dart';
...
class TransferToWalletSection extends StatefulWidget {
  const TransferToWalletSection({super.key});

  @override
  State<TransferToWalletSection> createState() =>
      _TransferToWalletSectionState();
}

class _TransferToWalletSectionState extends State<TransferToWalletSection> {
